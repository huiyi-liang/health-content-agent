...
class FakeStructuredModel:
    ...
    def invoke(self, messages: list[tuple[str, str]]) -> dict[str, Any]:
        ...
        assert "do not include detailed study statistics" in messages[0][1].lower()
        assert "A practical care" in messages[0][1]
        assert "threshold may be included" in messages[0][1]
        ...
        assert "Do not use quantitative study outcomes" in messages[0][1]
